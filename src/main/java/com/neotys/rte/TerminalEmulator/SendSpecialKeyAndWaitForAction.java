 ...
 */
public class SendSpecialKeyAndWaitForAction implements Action {
    private static final String BUNDLE_NAME = "com.neotys.rte.TerminalEmulator.bundle";
    private static final String DISPLAY_NAME = ResourceBundle.getBundle(BUNDLE_NAME, Locale.getDefault()).getString("displayNameSendSpecialKeyAndWaitFor");
    ...
    public String getType() {
        return "SendSpecialKeyAndWaitFor";
    }
